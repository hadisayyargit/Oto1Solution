...
public partial class Basket_open : ContentPage
{
    ...
    private async void RefreshForm()
    {
        ...
        string servicestatusserie = ((byte)GlobalClass.enumServiceStatus.servicestatus_Sending).ToString()
            + "," + ((byte)GlobalClass.enumServiceStatus.servicestatus_Refusal).ToString()
            + "," + ((byte)GlobalClass.enumServiceStatus.servicestatus_Reject).ToString()
            + "," + ((byte)GlobalClass.enumServiceStatus.servicestatus_Imperfect).ToString()
            + "," + ((byte)GlobalClass.enumServiceStatus.servicestatus_Done).ToString();
