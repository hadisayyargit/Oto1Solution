...
public partial class SignUp : ContentPage
{
    ...
    private async void btnSignUp_Clicked(object sender, EventArgs e)
    {
        ...
        if (CheckValidation())
        {
            try
            {
                ...
                user1.UserRole = (byte)GlobalClass.enumUserRole.userrole_vendor;
                user1.IsActive = true;
                ...
                {
                    ///ذخیره اطلاعات تامین کننده
                    vendor1.FName = txtFName.Text;
                    vendor1.LName = txtLName.Text;
                    vendor1.UserId = txtUsername.Text;

                    newvendor = await this.MyServiceController.AddVendor(vendor1);
                    activityIndicator.IsRunning = false;
                    if (newvendor != null)
                    {
    ...
    private bool CheckValidation()
    {
        ...
        {
            DisplayAlert("هشدار", "نام تامین کننده رو وارد کن", "تایید");
            return false;
        }
