...
public partial class Requests : ContentPage
{
    ...
    public Requests()
	{
        ...
        myLocationServices.Add(new CustomerServiceItemViewModel() { ServiceItemTypeName = "باتری به باتری", ThumbnailPhotoFile = "carbattery2.png", ServiceType = (byte)GlobalClass.enumServiceType.servicetype_OnLocationService, ServiceItemType = (byte)GlobalClass.enumServiceItemType.serviceitemtype_Battery,  tmp_OpacityControl = "0.5", tmp_IsActiveControl = false });
        ...
        myLocationServices.Add(new CustomerServiceItemViewModel() { ServiceItemTypeName = "باز کردن درب خودرو", ThumbnailPhotoFile = "car_door_lock.png", ServiceType = (byte)GlobalClass.enumServiceType.servicetype_OnLocationService, ServiceItemType = (byte)GlobalClass.enumServiceItemType.serviceitemtype_DoorOpening, tmp_OpacityControl = "0.5", tmp_IsActiveControl = false });
